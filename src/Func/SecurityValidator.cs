...
namespace Func
{
    ...
    {
        private readonly AzureADB2COptions _securityValidatorOptions;
        private TokenValidationParameters _tokenValidationParameters;
        private SemaphoreSlim _initializationSemaphore = new SemaphoreSlim(1, 1);

        public SecurityValidator(IOptions<AzureADB2COptions> securityValidatorOptions)
        {
        ...
        private async Task InitializeAsync()
        {
            var configurationManager = new ConfigurationManager<OpenIdConnectConfiguration>(
                $"https://{_securityValidatorOptions.TenantName}.b2clogin.com/{_securityValidatorOptions.TenantName}.onmicrosoft.com/{_securityValidatorOptions.SignInPolicy}/v2.0/.well-known/openid-configuration",
            ...
            _tokenValidationParameters = new TokenValidationParameters
            {
                ...
                ValidIssuers = new[]
                {
                    $"https://{_securityValidatorOptions.TenantName}.b2clogin.com/{_securityValidatorOptions.TenantId}/v2.0/"
                },
